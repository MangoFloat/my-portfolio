...
function Test(elementId) {
  ...
  var elementHeight = elementToScrollTo.getBoundingClientRect().top + window.pageYOffset;

  console.log({elementHeight: elementHeight, headerOffset: headerOffset});
    ...
    <Paper id='header' className={classes.root}>
      <Grid container>
        ...
        {Object.values(links).map((link) =>
          <Grid item>
            <Typography>
              <Button onClick={() => {Test(link.scrollTo)}} className={classes.links}>
                {link.title}
              </Button>
            </Typography>
          </Grid>,
